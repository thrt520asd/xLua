...
(lapi_func_ptr) &lua_pushnil,//31
(lapi_func_ptr) &lua_pushint64,//32
(lapi_func_ptr) &lua_pushuint64,//33
(lapi_func_ptr) &luaL_error,//34
(lapi_func_ptr) &lua_remove,//35
(lapi_func_ptr) &lua_insert,//36
(lapi_func_ptr) &lua_replace,//37
(lapi_func_ptr) &lua_copy,//38
(lapi_func_ptr) &xlua_createstruct_pointer,//39
(lapi_func_ptr) &xlua_pushstruct_pointer,//40
(lapi_func_ptr) &xlua_tocss,//41
(lapi_func_ptr) &xlua_getglobal,//42
(lapi_func_ptr) &xlua_setglobal,//43
(lapi_func_ptr) &lua_isint64,//44
(lapi_func_ptr) &lua_isuint64,//45
(lapi_func_ptr) &lua_toint64,//46
(lapi_func_ptr) &lua_touint64,//47
(lapi_func_ptr) &load_error_func,//48
(lapi_func_ptr) &xlua_get_registry_index,//49
(lapi_func_ptr) &xlua_rawgeti,//50
(lapi_func_ptr) &xlua_rawseti,//51
(lapi_func_ptr) &lua_pcall,//52
(lapi_func_ptr) &pcall_prepare,//53
(lapi_func_ptr) &luaL_ref,//54
(lapi_func_ptr) &xlua_tag,//55
(lapi_func_ptr) &lua_rawget,//56
(lapi_func_ptr) &lua_rawset,//57
(lapi_func_ptr) &luaL_newmetatable,//58
(lapi_func_ptr) &xlua_pushinteger,//59
...
(lapi_func_ptr) &lua_newuserdatauv,//66
(lapi_func_ptr) &lua_setmetatable,//67
};
//genEnd
